...
namespace beatbox
{
    ...
    public abstract class ParticleSystem : Component
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // initializeConstants
            this.parent.explosion_sprite_batch.Begin(spriteBlendMode);
            ...
            foreach (Particle p in particles)
            {
                ...
                this.parent.explosion_sprite_batch.Draw(texture, p.Position, null, color,
                    p.Rotation, origin, scale, SpriteEffects.None, 0.0f);
            }

            this.parent.explosion_sprite_batch.End();
